...
function AcceptTask({data}) {
  return (
    <div>
      <div className='h-full shrink-0 w-[280px] rounded-2xl bg-lime-500'>
        ...
        <div className='flex justify-between w-full p-2 mt-4'>
            <button className='px-2 py-1 font-semibold bg-green-500 rounded-md text-xs'>Mark as Completed</button>
            <button className='px-2 py-1 font-semibold bg-red-500 rounded-md text-xs'>Mark as Failed</button>
        </div>
      </div>
    </div>
  )
